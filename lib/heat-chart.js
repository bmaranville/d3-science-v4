  ...
  function heatChart(options_override) {
    ...
    function chart(selection) {
      selection.each(function (data) {
        ...
        var wrapper = outercontainer.append("div").style("display", "flex").style("flex-direction", "row");
        ...
        var container = wrapper.append("div").attr("class", "heatmap-container").style("flex", 1).style("position", "relative").style("height", innerheight + "px");
    ...
    chart.colorbar = function (selection) {
      selection.each(function (data) {
        ...
        var colorbarCanvas;
        var container = chart.wrapper.append("div").attr("class", "colorbar-container").style("position", "relative").style("flex", "0 0 " + innerwidth + "px").style("height", innerheight + "px");

        var colorbarCanvas = container.append("canvas").attr("width", width).attr("height", height).attr("class", "colorbar").style("width", width + "px").style("height", height + "px").style("top", options.cb_margin.top + "px").style("left", options.cb_margin.left + "px");
        ...
        svg.selectAll("g.z").attr("transform", "translate(" + (innerwidth - options.cb_margin.right) + "," + options.cb_margin.top + ")");
    ...
    chart.autofit = function () {
      ...
      //zoom.x(x).y(y);
      wrapper.select(".heatmap-container").attr("height", innerheight).style("height", innerheight + "px");

      wrapper.select("canvas.mainplot").attr("width", width).attr("height", height).style("width", width + "px").style("height", height + "px");

      chart.svg.attr("width", innerwidth).attr("height", innerheight);
      ...
      wrapper.select(".colorbar-container").attr("width", innerwidth).attr("height", innerheight).style("width", innerwidth + "px").style("height", innerheight + "px");

      wrapper.select("canvas.colorbar").attr("width", width).attr("height", height).style("width", width + "px").style("height", height + "px").call(drawScale);

      chart.colorbar.svg.select(".z.axis").call(zAxis);
      chart.colorbar.svg.attr("width", innerwidth).attr("height", innerheight);

      chart.colorbar.svg.selectAll("g.z").attr("transform", "translate(" + (innerwidth - options.cb_margin.right) + "," + options.cb_margin.top + ")");
