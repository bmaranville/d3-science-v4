(function (global, factory) {
  if (typeof define === "function" && define.amd) {
    define(['exports', './heat-chart.js', './xy-chart.js', './jquery-extend.js', './rectangle-select.js', './colormap.js', './dataflow-editor.js', './x-slice-interactor.js', './rectangle-interactor.js', './monotonic-function-interactor.js', './y-slice-interactor.js', './ellipse-interactor.js', './heat-chart-multi.js', './linePolygonIntersect.js', './polygon-interactor.js', './profile-interactor.js'], factory);
  } else if (typeof exports !== "undefined") {
    factory(exports, require('./heat-chart.js'), require('./xy-chart.js'), require('./jquery-extend.js'), require('./rectangle-select.js'), require('./colormap.js'), require('./dataflow-editor.js'), require('./x-slice-interactor.js'), require('./rectangle-interactor.js'), require('./monotonic-function-interactor.js'), require('./y-slice-interactor.js'), require('./ellipse-interactor.js'), require('./heat-chart-multi.js'), require('./linePolygonIntersect.js'), require('./polygon-interactor.js'), require('./profile-interactor.js'));
  } else {
    var mod = {
      exports: {}
    };
    factory(mod.exports, global.heatChart, global.xyChart, global.jqueryExtend, global.rectangleSelect, global.colormap, global.dataflowEditor, global.xSliceInteractor, global.rectangleInteractor, global.monotonicFunctionInteractor, global.ySliceInteractor, global.ellipseInteractor, global.heatChartMulti, global.linePolygonIntersect, global.polygonInteractor, global.profileInteractor);
    global.index = mod.exports;
  }
})(this, function (exports, _heatChart, _xyChart, _jqueryExtend, _rectangleSelect, _colormap, _dataflowEditor, _xSliceInteractor, _rectangleInteractor, _monotonicFunctionInteractor, _ySliceInteractor, _ellipseInteractor, _heatChartMulti, _linePolygonIntersect, _polygonInteractor, _profileInteractor) {
  'use strict';
