  ...
  function xyChart(options_override) {
    ...
    chart.draw_legend = function (data) {
      ...
      update_sel.enter().append('g').each(function (d, i) {
        ...
        g.append("rect").attr("x", -options.legend.left).attr("y", i * 25 + 15).attr("width", 10).attr("height", 10).style("fill", get_series_color(null, i)).style("stroke", get_series_color(null, i)).style("cursor", "pointer").on("mouseover", function () {
