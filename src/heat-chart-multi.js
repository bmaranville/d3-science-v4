...
export default function heatChartMulti(options_override, d3_import = null) {
  ...
  */
  var colormap = d3.scaleLinear().domain([0, 31, 63, 95, 127, 159, 191, 223, 255])
